...
- `melanoma_anti_pd1_primary`: n=160, pooled AUROC=0.641, mean fold AUROC=0.593, ECE=0.268.
...
- `melanoma_binary_response_stress`: n=29, pooled AUROC=0.404, mean fold AUROC=0.449, ECE=0.433.

## Eight Existing Baselines Exceeded In RECIST-Supported Primary

- IFNG: EcoNiche-Opt AUROC=0.685 vs baseline AUROC=0.640; delta=0.045, FDR q=0.108 (point_estimate_only).
- CXCL9: EcoNiche-Opt AUROC=0.685 vs baseline AUROC=0.649; delta=0.035, FDR q=0.200 (point_estimate_only).
- TIG: EcoNiche-Opt AUROC=0.685 vs baseline AUROC=0.644; delta=0.040, FDR q=0.100 (point_estimate_only).
- TIDE_dysfunction: EcoNiche-Opt AUROC=0.685 vs baseline AUROC=0.646; delta=0.039, FDR q=0.135 (point_estimate_only).
- APM: EcoNiche-Opt AUROC=0.685 vs baseline AUROC=0.642; delta=0.043, FDR q=0.216 (point_estimate_only).
- CYT: EcoNiche-Opt AUROC=0.685 vs baseline AUROC=0.624; delta=0.060, FDR q=0.042 (FDR_supported).
- IPRES: EcoNiche-Opt AUROC=0.685 vs baseline AUROC=0.573; delta=0.111, FDR q=0.122 (point_estimate_only).
- TIDE_exclusion: EcoNiche-Opt AUROC=0.685 vs baseline AUROC=0.539; delta=0.145, FDR q=0.093 (point_estimate_only).
