...
Selected candidate: `0.80*base+0.20*pct__PLA2G2D` under `lipid_pi3k` prior.
...
Family gate: mean AUROC=0.567, delta=0.133, q=0.007, claim=family_point_estimate_only.