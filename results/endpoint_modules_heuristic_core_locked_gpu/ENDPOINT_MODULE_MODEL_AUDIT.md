...
- primary_recist / melanoma_core_high_evidence vs CYT: target AUROC=0.705, baseline AUROC=0.630, bootstrap delta=0.076, 95% CI [0.023, 0.133], FDR q=0.021; target is above this comparator.
- primary_recist / melanoma_core_high_evidence vs PDCD1LG2: target AUROC=0.705, baseline AUROC=0.591, bootstrap delta=0.116, 95% CI [0.030, 0.199], FDR q=0.021; target is above this comparator.
...
- primary_recist / melanoma_core_high_evidence vs EcoNiche-Opt-WordNoInteraction: target AUROC=0.705, baseline AUROC=0.503, bootstrap delta=0.204, 95% CI [0.072, 0.337], FDR q=0.021; target is above this comparator.
- primary_recist / melanoma_core_high_evidence vs EcoNiche-Opt-WordUnsignedGraph: target AUROC=0.705, baseline AUROC=0.488, bootstrap delta=0.222, 95% CI [0.084, 0.361], FDR q=0.000; target is above this comparator.
- primary_recist / melanoma_core_high_evidence vs EcoNiche-Opt-WordNoBioObjective: target AUROC=0.705, baseline AUROC=0.467, bootstrap delta=0.242, 95% CI [0.125, 0.370], FDR q=0.000; target is above this comparator.
...
- primary_recist / melanoma_recist_supported_primary vs EcoNiche-Opt-ImmuneComposite: target AUROC=0.685, baseline AUROC=0.620, bootstrap delta=0.064, 95% CI [0.004, 0.125], FDR q=0.072; target is above this comparator.
...
- primary_recist / melanoma_recist_supported_primary vs EcoNiche-Opt-WordNoInteraction: target AUROC=0.685, baseline AUROC=0.585, bootstrap delta=0.098, 95% CI [0.006, 0.191], FDR q=0.072; target is above this comparator.
...
- primary_recist / melanoma_recist_supported_primary vs TIDE_exclusion: target AUROC=0.685, baseline AUROC=0.539, bootstrap delta=0.143, 95% CI [0.004, 0.277], FDR q=0.080; target is above this comparator.
- primary_recist / melanoma_recist_supported_primary vs EcoNiche-Opt-WordUnsignedGraph: target AUROC=0.685, baseline AUROC=0.500, bootstrap delta=0.182, 95% CI [0.069, 0.302], FDR q=0.009; target is above this comparator.
- primary_recist / melanoma_recist_supported_primary vs EcoNiche-Opt-WordNoBioObjective: target AUROC=0.685, baseline AUROC=0.429, bootstrap delta=0.253, 95% CI [0.151, 0.360], FDR q=0.000; target is above this comparator.
